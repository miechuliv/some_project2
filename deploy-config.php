 ...
 * @var string
 */
define('SECRET_ACCESS_TOKEN', 'SDF123FG');
 ...
 * @var string
 */
define('REMOTE_REPOSITORY', 'https://github.com/miechuliv/some_project2.git');
 ...
 */
define('TARGET_DIR', '/domains/demo.stronazen.pl/public_html/some_project2/');
 ...
 * @var string Full path including the trailing slash
 */
define('TMP_DIR', '/domains/demo.stronazen.pl/public_html/tmp/spgd-'.md5(REMOTE_REPOSITORY).'/');
